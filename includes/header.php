...
<head>
    ...
    <!-- Bootstrap JS Bundle (Necessário para a navegação mobile/collapse funcionar) -->
            ...
            <?php if (isset($_SESSION['usuario_id'])): ?>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mt-2 mt-lg-0">
                    <?php if ($usuario_tipo === 'admin'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $pagina_atual === 'dashboard' ? 'active' : '' ?>" href="/dashboard">
                                <i class="bi bi-speedometer2"></i> Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $pagina_atual === 'clientes' ? 'active' : '' ?>" href="/clientes">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $pagina_atual === 'nova-obra' ? 'active' : '' ?>" href="/nova-obra">
                                <i class="bi bi-plus-circle-fill"></i> Nova Obra
                            </a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link <?= $pagina_atual === 'portal' ? 'active' : '' ?>" href="/portal">
                                <i class="bi bi-house-heart-fill"></i> Minha Obra
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
