...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($usuario) || empty($senha)) {
        ...
        if ($admin && password_verify($senha, $admin['senha'])) {
            ...
            $_SESSION['usuario_nome'] = $admin['nome'] ?? $admin['usuario'];
...
<div class="container d-flex flex-grow-1 align-items-center justify-content-center py-4 py-md-5">
    <div class="card card-login p-3 p-sm-4 w-100">
        <div class="text-center mb-4">
            ...
            <h4 class="fw-bold mt-2">Área Administrativa</h4>
            <p class="text-muted small">Acesso restrito aos administradores</p>
        </div>
        ...
        <div class="text-center mt-4 pt-2 border-top">
            <a href="/login" class="text-decoration-none small text-muted">
                <i class="bi bi-arrow-left me-1"></i> Voltar para o Portal do Cliente
            </a>
        </div>
    </div>
</div>
