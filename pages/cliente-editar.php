        ...
        if (strlen($cpfLimpo) !== 11) {
            ...
            if ($stmtCheck->fetch(PDO::FETCH_ASSOC)) {
                ...
                try {
                    ...
                    header('Location: /cliente-editar?id=' . $id . '&sucesso=1');
                    exit;
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3 mb-4">
                <div class="flex-grow-1">
                    <h3 class="fw-bold m-0 text-nowrap">
                        <i class="bi bi-person-gear me-2 text-primary"></i>Editar Cliente
                    </h3>
                    <p class="text-muted m-0 small">
                        Atualize os dados do cliente ou usuário
                    </p>
                </div>
            ...
            <div class="card border-0 shadow-sm p-3 p-md-4">
                ...
                <form method="POST" action="/cliente-editar?id=<?= (int) $id ?>">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($usuario['endereco'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                            >
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="tipo" class="form-select">
                                <option
                                    value="cliente"
                                    <?= (($usuario['tipo'] ?? 'cliente') === 'cliente') ? 'selected' : '' ?>
                                >
                                    Cliente
                                </option>
